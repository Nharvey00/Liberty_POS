<x-app-layout>
    ...
    <form method="POST" action="{{ route('credit-accounts.update', $credit_account) }}" class="bg-white border border-[#E5E9EF] rounded-[16px] p-6 max-w-4xl">
        ...
        <div class="grid grid-cols-2 gap-4 mb-5">
            {{-- Customer (Read-only — cannot change which customer owns this account) --}}
        ...
        <div class="flex items-center gap-3 pt-5 border-t border-[#E5E9EF]">
            <a href="{{ route('credit-accounts.show', $credit_account) }}" class="rounded-lg px-[15px] py-[10px] text-[13px] font-semibold border border-[#E5E9EF] bg-white text-[#1C2430] hover:bg-[#F4F6F9]">Cancel</a>
