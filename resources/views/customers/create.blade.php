        ...
        <div class="grid grid-cols-2 gap-4 mb-5">
            ...
            <div class="col-span-2 md:col-span-1">
                ...
                <select name="customer_type" id="customer_type" required class="w-full px-3 py-2.5 border border-[#E5E9EF] rounded-lg text-[14px] bg-white focus:ring-[#0B3B70] focus:border-[#0B3B70]">
                    <option value="Normal" {{ old('customer_type') == 'Normal' ? 'selected' : '' }}>Normal Customer</option>
                    <option value="Company" {{ old('customer_type') == 'Company' ? 'selected' : '' }}>Company / Corporate (Residual Calculation)</option>
                </select>
