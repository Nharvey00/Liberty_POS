    ...
    <form method="POST" action="{{ route('users.store') }}" class="bg-white border border-[#E5E9EF] rounded-[16px] p-6 max-w-4xl">
        ...
        <div class="grid grid-cols-2 gap-4 mb-5">
            <div class="col-span-2">
                ...
                <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full px-3 py-2.5 border border-[#E5E9EF] rounded-lg text-[14px] focus:ring-[#0B3B70] focus:border-[#0B3B70]">
            ...
            <div class="col-span-2">
                ...
                <input type="email" name="email" id="email" value="{{ old('email') }}" required class="w-full px-3 py-2.5 border border-[#E5E9EF] rounded-lg text-[14px] focus:ring-[#0B3B70] focus:border-[#0B3B70]">
            ...
            <div class="col-span-2 md:col-span-1">
                <label for="password" class="block text-[11.5px] font-semibold text-[#5B6472] mb-1.5">Temporary Password <span class="text-[#B5504B]">*</span></label>
                <input type="password" name="password" id="password" required class="w-full px-3 py-2.5 border border-[#E5E9EF] rounded-lg text-[14px] focus:ring-[#0B3B70] focus:border-[#0B3B70]">
                @error('password') <span class="text-[#B5504B] text-[11px] mt-1 block">{{ $message }}</span> @enderror
            </div>

            <div class="col-span-2 md:col-span-1">
                <label for="password_confirmation" class="block text-[11.5px] font-semibold text-[#5B6472] mb-1.5">Confirm Password <span class="text-[#B5504B]">*</span></label>
                <input type="password" name="password_confirmation" id="password_confirmation" required class="w-full px-3 py-2.5 border border-[#E5E9EF] rounded-lg text-[14px] focus:ring-[#0B3B70] focus:border-[#0B3B70]">
            </div>
        </div>
        ...
        <div class="flex items-center gap-3 pt-5 border-t border-[#E5E9EF]">
            ...
            <button type="submit" class="rounded-lg px-[15px] py-[10px] text-[13px] font-semibold border border-[#0B3B70] bg-[#0B3B70] text-white hover:bg-[#082A52]">Create Staff Account</button>
        </div>
    </form>
</x-app-layout>