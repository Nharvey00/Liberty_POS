<x-app-layout>
    ...
    <div class="bg-white border border-[#E5E9EF] rounded-[16px] p-5 mb-5 max-w-4xl">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            <div>
                <div class="text-[11px] uppercase tracking-[0.04em] text-[#5B6472] font-semibold mb-1">Agreed Monthly</div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-5">
            <div class="col-span-2 md:col-span-1">
                ...
                @if($remainingBalance > 0)
                    <p class="text-[11px] text-[#5B6472] mt-1">Outstanding balance: ₱{{ number_format($remainingBalance, 2) }}</p>
                @else
                    <p class="text-[11px] text-[#1E8E5A] font-semibold mt-1">Balance is fully cleared.</p>
                @endif
            </div>
        </div>
